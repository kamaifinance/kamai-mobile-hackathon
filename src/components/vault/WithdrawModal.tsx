...
interface WithdrawModalProps {
  ...
  onClose: () => void;
  onWithdraw: (vault: VaultInfo, amount: number) => Promise<string>;
...
export default function WithdrawModal({
  ...
  const handlePercentagePress = (percentage: number) => {
    const calculatedAmount = (withdrawableAmount * percentage / 100);
    setAmount(calculatedAmount.toFixed(6)); // Show up to 6 decimal places
  };
  ...
  const handleWithdraw = async () => {
    ...
    if (numAmount > withdrawableAmount) {
      Alert.alert('Error', `Insufficient balance. Maximum withdrawable amount is ${withdrawableAmount.toFixed(6)} ${vault.tokenSymbol}.`);
      return;
    }
          ...
          <View style={styles.bottomSheet}>
            ...
            >
              <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollView}>
                ...
                <Text style={styles.title}>Withdraw from {getVaultType(vault?.tokenSymbol || '')} Vault</Text>
                ...
                <View style={styles.balanceSection}>
                  ...
                  <Text style={styles.balanceAmount}>
                    {withdrawableAmount.toFixed(6)} {vault?.tokenSymbol || ''}
                  </Text>
                </View>
                ...
                <View style={styles.buttonContainer}>
                  <TouchableOpacity
                    style={[styles.cancelButton, withdrawing && styles.disabledButton]}
                    onPress={handleClose}
                    disabled={withdrawing}
                  >
                  ...
                  <TouchableOpacity
                    style={[
                      ...
                      (!amount || withdrawing) && styles.depositButtonDisabled,
                    ]}
                    onPress={handleWithdraw}
                    disabled={!amount || withdrawing}
                  >
                    {withdrawing ? (
